<script lang="ts">
  ...
  import picture from "../../../../img/cropped/nonfiction/middle.jpg?enhanced";
  import _shapes from "../../../../content/shelves/nonfiction/middle.json";
  ...
  >("../../../../content/shelves/nonfiction/middle/*.md", { eager: true });
  ...
  const externalShapes = Object.values(
    import.meta.glob<true, string, { title: string; href: string; shape: Coords }>(
      "../../../../content/shelves/nonfiction/middle/*.json",
      { eager: true },
    ),
  );
</script>

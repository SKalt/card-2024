<script lang="ts">
  ...
  import picture from "../../../../img/cropped/back/b2.jpg?enhanced";
  import _shapes from "../../../../content/shelves/back/b2.json";
  ...
  >("../../../../content/shelves/back/b2/*.md", { eager: true });

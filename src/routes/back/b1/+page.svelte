<script lang="ts">
  ...
  import picture from "../../../../img/cropped/back/b1.jpg?enhanced";
  import _shapes from "../../../../content/shelves/back/b1.json";
  ...
  >("../../../../content/shelves/back/b1/*.md", { eager: true });
